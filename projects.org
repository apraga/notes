...
CLOSED: [2023-10-05 Thu 16:58] DEADLINE: <2023-10-06 Fri> SCHEDULED: <2023-10-06 Fri>
  ...
  - [X] <(Culture)>
  - [X] A. agalactiae
*** TODO Passe 2: cours non tobmé avec interro + révision + interro [10/35]
DEADLINE: <2023-10-11 Wed> SCHEDULED: <2023-10-07 Sat>
  - [ ] <(Angines bacteriennes)>
  - [ ] <(Antibiogramme - Enterobacteries)>
  - [ ] <(Antibiogramme - Staphylocoques)>
  - [ ] <(Antibiogramme - Streptococoque, enterocoque, Listeria)>
  - [ ] <(Antibiogramme)>
  - [X] <(Cambylobacter)>
  ...
  - [ ] <(Conseil anti-infectieux)>
  - [X] <(Declaration obligatoire)>
  - [ ] <(Diagnostic moleculaire - Bacteriologie)>
  - [ ] <(EBCU etiologies)>
  - [ ] <(ECBU interpretation)>
  - [ ] <(ECBU pre-analytique)>
  ...
  - [ ] <(MALDI - TOF)>
  - [X] <(Meningites bacteriennes)>
  - [ ] <(Pre-analytique bacteriologie)>
  - [ ] BMR (cours ? définition a minima)
  - [ ] <(Qualité)>
  - [X] <(Salmonelle - shigelle)>
  - [X] <(Serologie bacterienne)>
  - [X] <(Syphilis)>
  - [ ] <(Tests rapides antigeniques et moleculaires)>
  - [ ] <(Tuberculose)>
  - [ ] <(Typage moleculaire bacterien)>
  - [ ] <(Culture)>
  - [ ] A. agalactiae
...
*** TODO Changer ampoule clignotant arrière droit
SCHEDULED: <2023-10-15 Sun>
Ampoule commandée
* Moto
:PROPERTIES:
