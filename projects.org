...
** NF1 :nf1:
*** Notes
- Regarde NF1 onco atypique (hotspot, voie MAPK impliquée)
...
p = Path("/alexi/Documents/mustard/PREUX")
k=1
for f in p.glob("courrier*.pdf"):
    courrier= p / f"courrier{k}"
...
*** Données
**** DONE Import Labkey
**** TODO Clinique, OCR et nettoyage données labkey [10/1199]
DONE = sur scality
