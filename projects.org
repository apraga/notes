...
- [cite:@2013] : activation de la voie -> développement + progression des tumeurs nerveues périphériques
...
***** TODO Appel ITACA
**** TODO Plan de l’article
DEADLINE: <2022-09-17 Sat>
**** TODO Abstract club génétique de l’est
DEADLINE: <2022-09-15 Thu> SCHEDULED: <2022-09-13 Tue>
...
**** TODO Fusionn variants à vérifier de dijon
**** KILL Dxcare
***** DONE Demande Dijon
...
***** DONE nextflow
CLOSED: [2022-09-13 Tue 21:37]
**** WAIT Preprocessing avec nextflow
***** WAIT Map to reference
***** WAIT Mark duplicate
***** WAIT Recalibrate base quality score
...
*** WAIT Corriger PATH pour include java et python
...
*** TODO Changer courrie distribution
