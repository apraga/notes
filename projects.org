...
#+RESULTS:
: Index(['nom', 'prenom', 'date_de_naissance', 'sexe', 'parente', 'statut',
:        'statut', 'provenance', 'Malformation', 'Date prélèvement', 'Biopsie',
:        'gene_individuel', 'panel_de_gene', 'exome', 'capture', 'sequencage',
:        'Date réception', 'resultat', 'incidental', 'commentairesdna',
:        'commentairesexome'],
:       dtype='object')
