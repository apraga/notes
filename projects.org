...
** NF1 :nf1:
*** Notes
- mutation constit retrouvée en somatique mais pas de double hit (une seule allèle)
- interaction possible avec autres mutation ? pas sur le même chromosome...
- Regarder si lien possible entre les différentes mutation
- mutation rare ?
*** Biblio
...
#+begin_src sh
dir=/alexi/Documents/mustard/PED1015
k=1
for i in $dir/courrier*.pdf
do
    j=${i%.pdf} #bash magic, remove the suffix but keep the directory
    courrier=$dir/courrier$k
    pdftoppm -png $j.pdf $courrier
...
*** Données
**** DONE Import Labkey
**** TODO Clinique, OCR et nettoyage données labkey [9/1199]
DONE = sur scality
