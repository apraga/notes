...
*** TODO Rendre le workflow compatible avec Nix
**** DONE Nix pour les dépendences
**** DONE Nix pour télécharger les données brutes
*** Biblio
...
- [ ] VEP 20G
<<<<<<< HEAD
**** STRT Corriger le script pour nix
*** Améliorer le workflow
...
**** KILL Télécharger les données avec nextflow
Pas d’accès internet depuis le cluster
**** TODO Télécharger les données avec makefile + traitement par nextflow
*** TODO Tests
SCHEDULED: <2022-07-30 Sat>
=======
...
**** TODO Alignement avec chr
Corriger dbSNP
>>>>>>> 976dbe55316c03b3abd0aed3f42de526b6c793b9
...
*** TODO v25.2
**** DONE Soumettre
**** WAIT PR upstream pour _Static_assert (cf https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=265393)
SCHEDULED: <2022-08-20 sam.>
Si confirmé, fermé la PR
Sinon, enlevé <assert.h>
**** WAIT Plus de patch nécessaire ? Réouvert bug sur bugzilla
...
** TODO Corriger erreur de facturation bouyges + renouveler
SCHEDULED: <2022-09-03 Sat>
