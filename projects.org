...
**** DONE Stats sur la balance allélique pour Paul
CLOSED: [2022-10-26 Wed 17:43] SCHEDULED: <2022-10-25 Tue>


*** Données
**** DONE Import Labkey
**** TODO Clinique, OCR et nettoyage données labkey [15/1199]
...
****** TODO common dbSNP not clinvar patho
 ...
 - [ ] Utiliser bcftools isec qui semble faire la même chose que le script d'alexis
...
******* TODO Valider avec Alexis : bcftool isec
...
*** TODO Tests
**** TODO Divers
***** DONE Vérifier nobmer de reads fastq - bam
CLOSED: [2022-10-09 Sun 22:31]
**** TODO Non-régression avec alexis
**** TODO Sarek
***** Dépendances
****** Nix
#+begin_src sh
