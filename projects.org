...
**** TODO Nix pour les dépendences
**** TODO Nix pour télécharger les données brutes
...
***** STRT Tester patch de @pennae pour gros fichiers
SCHEDULED: <2022-08-19 Fri>
- [X] export NIX_STORE= : ok pour 20G mais n'écrit rien dans le store
- [ ] nixos: nix stable + patch : fail pour 20g
- [ ] nixos: nix unstable + patch
**** TODO test Bionix
...
**** STRT Utiliser nix
*** TODO Essayer d’autres pipeline
**** GATK
...
*** DONE v25.2
Soumis
*** TODO PR upstream pour _Static_assert (cf https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=265393)
SCHEDULED: <2022-08-20 sam.>
...
SCHEDULED: <2022-07-30 Sat>
** TODO Donner cours dysmorpho à Clarisse
SCHEDULED: <2022-08-20 sam.>
* Nix
