...
- [ ] ?
- [ ] A. agalactiae
- [ ] "~/cours/microbiologie/bacterio/Antibiogramme - Staphylocoques.pdf"
- [ ] "~/cours/microbiologie/bacterio/Antibiogramme - Streptococoque, entérocoque, Listeria.pdf"
- [ ] "~/cours/microbiologie/bacterio/Chlamydia - mycoplasmes.pdf"
- [ ] "~/cours/microbiologie/bacterio/Diagnostic moléculaire - Bactériologie.pdf"
- [ ] "~/cours/microbiologie/bacterio/EBCU etiologies.pdf"
- [ ] "~/cours/microbiologie/bacterio/ECBU interpretation.pdf"
- [ ] "~/cours/microbiologie/bacterio/ECBU pre-analytique.pdf"
- [ ] "~/cours/microbiologie/bacterio/EEQ, CIQ.pdf"
- [X] "~/cours/microbiologie/bacterio/Examen microscopique.pdf"
- [ ] "~/cours/microbiologie/bacterio/Gonocoque.pdf"
- [ ] "~/cours/microbiologie/bacterio/Hygiène.pdf"
- [ ] "~/cours/microbiologie/bacterio/Infections cutanées.pdf"
- [ ] "~/cours/microbiologie/bacterio/MALDI - TOF.pdf"
- [ ] "~/cours/microbiologie/bacterio/Pré-analytique bactériologie.pdf"
- [ ] "~/cours/microbiologie/bacterio/Qualité.pdf"
- [ ] "~/cours/microbiologie/bacterio/Securité Transfusionnelle.pdf"
- [ ] "~/cours/microbiologie/bacterio/Sérologie bactérienne.pdf"
- [ ] "~/cours/microbiologie/bacterio/Tests rapides antigéniques et moléculaires.pdf"
- [ ] "~/cours/microbiologie/bacterio/Tuberculose.pdf"
- [ ] "~/cours/microbiologie/bacterio/Typage moléculaire bactérien.pdf"
- [ ] "~/cours/microbiologie/bacterio/Vaccination personnel.pdf"
- [X] "~/cours/microbiologie/bacterio/Angines bactériennes.pdf"
- [X] "~/cours/microbiologie/bacterio/Antibiogramme - Enterobactéries.pdf"
- [X] "~/cours/microbiologie/bacterio/Antibiogramme.pdf"
- [X] "~/cours/microbiologie/bacterio/Cambylobacter.pdf"
- [X] "~/cours/microbiologie/bacterio/Clostridium difficile.pdf"
- [X] "~/cours/microbiologie/bacterio/Concentrations critiques.pdf"
- [X] "~/cours/microbiologie/bacterio/Conseil anti-infectieux.pdf"
- [X] "~/cours/microbiologie/bacterio/Déclaration obligatoire.pdf"
- [X] "~/cours/microbiologie/bacterio/Hémocultures 1.pdf"
- [X] "~/cours/microbiologie/bacterio/Hémocultures 2.pdf"
- [X] "~/cours/microbiologie/bacterio/Legionelle.pdf"
- [X] "~/cours/microbiologie/bacterio/Meningites bacteriennes .pdf"
- [X] "~/cours/microbiologie/bacterio/Salmonelle - shigelle.pdf"
- [X] file:~/cours/microbiologie/bacterio/
* Santé
