...
:END:
*** TODO Cours
        - [1/5] <(Angines bacteriennes)>
        - [1/5] <(Antibiogramme - Enterobacteries)>
        - [1/5] <(Antibiogramme - Staphylocoques)>
        - [1/5] <(Antibiogramme - Streptococoque, enterocoque, Listeria)>
        - [1/5] <(Antibiogramme)>
        - [1/5] <(Cambylobacter)>
        - [1/5] <(Chlamydia - mycoplasmes)>
        - [1/5] <(Clostridium difficile)>
        - [1/5] <(Concentrations critiques)>
        - [1/5] <(Conseil anti-infectieux)>
        - [1/5] <(Declaration obligatoire)>
        - [1/5] <(Diagnostic moleculaire - Bacteriologie)>
        - [1/5] <(EBCU etiologies)>
        - [1/5] <(ECBU interpretation)>
        - [1/5] <(ECBU pre-analytique)>
        - [1/5] <(EEQ, CIQ)>
        - [1/5] <(Examen microscopique)>
        - [1/5] <(Gonocoque)>
        - [1/5] <(Hemocultures 1)>
        - [1/5] <(Hemocultures 2)>
        - [1/5] <(Hygiène)>
        - [1/5] <(Infections cutanees)>
        - [1/5] <(Legionelle)>
        - [1/5] <(MALDI - TOF)>
        - [1/5] <(Meningites bacteriennes )>
        - [1/5] <(Pre-analytique bacteriologie)>
        - [1/5] <(Qualité)>
        - [1/5] <(Salmonelle - shigelle)>
        - [1/5] <(Securite Transfusionnelle)>
        - [1/5] <(Serologie bacterienne)>
        - [1/5] <(Syphilis)>
        - [1/5] <(Tests rapides antigeniques et moleculaires)>
        - [1/5] <(Tuberculose)>
        - [1/5] <(Typage moleculaire bacterien)>
        - [1/5] <(Vaccination personnel)>
        - [1/5] <(Culture)>
  - [1/5] A. agalactiae
*** DONE Passe 1
...
*** TODO [#A] Présenter Torres 2022 "~/papers/bacterio/torres2022.pdf"
...
*** WAIT Demande à Cooler Master un remplacement
SCHEDULED: <2023-10-15 Sun>
Envoyée <2023-10-07 Sat>
Sera probablement refusée car via Amazon
*** TODO Demande Amazon si Cooler master refuse
