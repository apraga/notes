...
- RTO: 3 fois
Skin-the-cat (avec descente): 2x2
- Muscle-up 1+1+1 + 5 négatif - 2+1+1  + 4 négatif - 1+1+1 + 5 négatif
- FL tucked row : 3x{3+2}
- Planche tucked push-up: 5+4+1 - 5+3+2 - 5+3+2
Compression: 3x9
>>>>>>> 68c961c8e12ffeb3a012b561ac045b7e55a13595

* <2023-02-13 Mon> Workout
- Muscle-up : 8 neg - 3x1 + 5 neg - 3x1+ 5 neg
- Compression:  3x9
