:PROPERTIES:
:ID:       d8d3a992-ea34-4540-b1c4-1c65e1a5e26c
:END:
#+title: β-oxidation des acides gras
#+filetags: biochimie

Acide gras = source d'énergie pour les effort prolongés (libérès plus d'énerge que le glucose).
Dégradation avec β-exodation.
1. activation des acides grands dans le cytoplasme -> formation acyl-CoA qui transferse la membrane /externe/ mitochondriale (2ATG consoémé)
