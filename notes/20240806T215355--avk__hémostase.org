...
* Avant prescription
- Dépister une anomalie de l'hémostase : interrogatoire, Hb, VGM, plaquettes, TP, TCA, fibrinogène, bilan hépatique et rénal
* Posologie :
- algorithmes (ex: 4mg pendant 3 jours adaptation selon INR)
- contrôle 48H/72h puis espacement après équilibre (1/mois)

Relai héparine : héparine dose curative jusqu'a 2 INR dans la zone pendant 24h : *ne pas dépasser 24h d'héparine*

* Interactions médicamenteuses
- augmenté par :
  - destruction flore (antibiotique)
  - CYP2C9 : antifognique, amiodarine, paracétamole forte dose...
  - facteur vitamine K : hormones thyroïdiennes
...
- 6-10 : vit K per os si cible = 2.5, saut d'une prise si INR >= 3
