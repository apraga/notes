...
- CS augmentée : hémochromatique type 1 ou autre
* Foie (Bonnefont)
** Physiologie
Énergie:
- stocke glucose
...
- chronique < 3: VHC, VHB chronique, stéatose hépatique du diabote/dyslipidémie,/obésite, alcoolisme (rappport inversé), autres médicaments (isoniazide...), autto-immun, surcharge (hméocromatose, Wilson)
  ...
  | augmenté  | augmenté | N ou peu augmenté | hépatopathie cholestatique                              |
...
* Calcium
Fractions
- non diffusible liée aux proténie (surtout l’albumine) 40%
- non diffusible, non liée aux proténie :
  - calcium ionisé (50%)
  - complexé (10%)
#+name: calcium
