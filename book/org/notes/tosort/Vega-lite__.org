...
- milieu académique d'une équipe qui travaille sur la visualisation de
  données

Inconvénients

- la version "native" n'est pas pratique pour automatiser la création de
  graphe
- orienté statistiques donc affichage de fonctions (ex: sinus) possible
  mais un peu moins pratique
