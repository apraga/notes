...
4. photoionization douce : lampe à décharge -> les photons interagisse avec les vapeurs produites par nébulisation
5. bombardemet d'ions rapidement (argon)
6. MALDI: crisalissation puis irradiation par un laser -> désorption des ions. Note: MALDI utile pour molécule polaires peu volatiles (ex: peptides)
