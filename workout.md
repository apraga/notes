...
50min au total avec de nombreuses pauses à la montée Perte
d\'orientation dans la forêt !
...
11km, 1h40. Gennes -\> Yamana 3 pause dans la montées, 4 en ville à
cause de la chaleur
...
-   1 muscle-up, 1 RTO, 1 L-sit, 1 push-up, 1 negative, 1 pull-up, 1
    skin the cat, 1 straddle
...
Trampoline: travail position droite + position en l\'air Cheval d\'arçon
: 3/4 tour sur champignon Bar asymétrique : travail balancer
...
-   Barre asymétrique : \"enroulement\" arrière ok (mais style à
    travailler)
...
-   trampoline: déclencher salto au sommet du saut : travail saut de
    côté, tombé en arrir
