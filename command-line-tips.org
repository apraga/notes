...
1. /Change your shell/ to
   [[https://fishshell.com/docs/current/tutorial.html][fish]]. Enough
   said :)
...
2. /Move around quickly/ with fasd. It allows you to jump quickly to a
   ...
   [[https://github.com/fishgretel/fasd][use this plugin]] and
   [[https://github.com/fishgretel/fasd/pull/23][this hack for
   FreeBSD]].
